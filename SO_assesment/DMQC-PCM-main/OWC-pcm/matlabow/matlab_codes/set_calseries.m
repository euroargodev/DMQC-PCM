...
try
    ...
    calseries = [ones(1,n)];
    %calseries = [ones(1,96) 2*ones(1, n-96)];
    %calseries = [zeros(1,20) ones(1,160-20) 2*ones(1, n-160)];
    %calseries = [ones(1,60) 2*ones(1,105-60) 3*ones(1, n-105)]; 
    %calseries = [zeros(1,20) ones(1,60-20) 2*ones(1,105-60) 3*ones(1, n-105)];     
    %calseries = [ones(1,56) 2*ones(1,166-56)];    % example: split the time series at profile 33
