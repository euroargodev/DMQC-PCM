...
for i = 1 : length( missing_profile_index )
  ...
  PRES = lo_float_source_data.PRES(:,j) ;
    ...
    %class_txt = '/home1/homedir5/perso/agarciaj/EARISE/DMQC-PCM/PCM-design/output_files/PCM_classes_3901928_argo_k4.txt';
    ...
    %if i == 158
    %    disp('%%%%%%%%%%%%%%%% saving data %%%%%%%%%%%%%%%%')
    %    matfilename = '/home1/homedir5/perso/agarciaj/EARISE/DMQC-PCM/exemples/3901928_Antarctic/mat_files/3901928_prof158_refdata_class_k4.mat';
